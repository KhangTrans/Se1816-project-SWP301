...
<nav class="sidebar">
    ...
    <ul class="sidebar__nav">
        ...
        <li class="sidebar__nav-item">
            <a class="sidebar__nav-link" href="#" onclick="toggleDropdown('packagesDropdown')">
                <i class="fas fa-box-open"></i>
                Packages
                <i class="fas fa-chevron-down" style="float: right;"></i>
            </a>
            <ul id="packagesDropdown" class="sidebar__dropdown" style="display: none; padding-left: 20px;">
                <li>
