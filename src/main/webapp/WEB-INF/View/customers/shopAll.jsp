...
<main>
    <div class="body-product">
        <div class="content-wrapper">
            ...
            <h1 class="header-content" id="shop-section">SHOP</h1>
            ...
            <div class="product-grid" id="product-list">
                ...
                <div class="product-card">
                    ...
                    <div class="product-actions">
                        ...
                        <!-- Buy Now button -->
                        <button 
                            class="cart-icon-btn buy-now-btn"
                            onclick="window.location.href = '<%= request.getContextPath()%>/BuyNow?productId=<%= p.getProductId()%>'"
                            <%= stock < 1 ? "disabled style='opacity:0.5;pointer-events:none;' title='Out of stock'" : "title='Buy Now'"%>>
                            <i class="fas fa-bolt"></i> Buy Now
                        </button>
                        <!-- Detail button -->
                        <button 
                            class="cart-icon-btn details-btn"
