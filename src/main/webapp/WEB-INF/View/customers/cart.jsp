...
<div class="cart-container" >
    ...
    <div class="cart-summary">
        ...
        <form action="CartServlet" method="post" style="margin-top: 20px; text-align: center;">
            ...
            <button type="submit" style="color: white; border: none; background-color: red; padding: 10px 20px; border-radius: 5px; display: flex; align-items: center; justify-content: center; gap: 80px;">
                Clear all carts
                <i class="trash fas fa-trash-alt"></i>
            </button>
        </form>
